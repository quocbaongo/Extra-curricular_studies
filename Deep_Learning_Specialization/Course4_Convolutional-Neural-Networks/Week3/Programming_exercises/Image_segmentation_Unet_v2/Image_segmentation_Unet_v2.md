...
```
    ...
    ==================================================================================================
     ...
     conv2d_43 (Conv2D)             (None, 96, 128, 32)  896         ['input_9[0][0]']                
                                                                                                      
     conv2d_44 (Conv2D)             (None, 96, 128, 32)  9248        ['conv2d_43[0][0]']              
                                                                                                      
     max_pooling2d_11 (MaxPooling2D  (None, 48, 64, 32)  0           ['conv2d_44[0][0]']              
     )                                                                                                
                                                                                                      
     conv2d_45 (Conv2D)             (None, 48, 64, 64)   18496       ['max_pooling2d_11[0][0]']       
                                                                                                      
     conv2d_46 (Conv2D)             (None, 48, 64, 64)   36928       ['conv2d_45[0][0]']              
                                                                                                      
     max_pooling2d_12 (MaxPooling2D  (None, 24, 32, 64)  0           ['conv2d_46[0][0]']              
     )                                                                                                
                                                                                                      
     conv2d_47 (Conv2D)             (None, 24, 32, 128)  73856       ['max_pooling2d_12[0][0]']       
                                                                                                      
     conv2d_48 (Conv2D)             (None, 24, 32, 128)  147584      ['conv2d_47[0][0]']              
                                                                                                      
     max_pooling2d_13 (MaxPooling2D  (None, 12, 16, 128)  0          ['conv2d_48[0][0]']              
     )                                                                                                
                                                                                                      
     conv2d_49 (Conv2D)             (None, 12, 16, 256)  295168      ['max_pooling2d_13[0][0]']       
                                                                                                      
     conv2d_50 (Conv2D)             (None, 12, 16, 256)  590080      ['conv2d_49[0][0]']              
                                                                                                      
     dropout_5 (Dropout)            (None, 12, 16, 256)  0           ['conv2d_50[0][0]']              
                                                                                                      
     max_pooling2d_14 (MaxPooling2D  (None, 6, 8, 256)   0           ['dropout_5[0][0]']              
     )                                                                                                
                                                                                                      
     conv2d_51 (Conv2D)             (None, 6, 8, 512)    1180160     ['max_pooling2d_14[0][0]']       
                                                                                                      
     conv2d_52 (Conv2D)             (None, 6, 8, 512)    2359808     ['conv2d_51[0][0]']              
                                                                                                      
     dropout_6 (Dropout)            (None, 6, 8, 512)    0           ['conv2d_52[0][0]']              
                                                                                                      
     conv2d_transpose_7 (Conv2DTran  (None, 12, 16, 256)  1179904    ['dropout_6[0][0]']              
     spose)                                                                                           
                                                                                                      
     concatenate_6 (Concatenate)    (None, 12, 16, 512)  0           ['conv2d_transpose_7[0][0]',     
                                                                      'dropout_5[0][0]']              
                                                                                                      
     conv2d_53 (Conv2D)             (None, 12, 16, 256)  1179904     ['concatenate_6[0][0]']          
                                                                                                      
     conv2d_54 (Conv2D)             (None, 12, 16, 256)  590080      ['conv2d_53[0][0]']              
                                                                                                      
     conv2d_transpose_8 (Conv2DTran  (None, 24, 32, 128)  295040     ['conv2d_54[0][0]']              
     spose)                                                                                           
                                                                                                      
     concatenate_7 (Concatenate)    (None, 24, 32, 256)  0           ['conv2d_transpose_8[0][0]',     
                                                                      'conv2d_48[0][0]']              
                                                                                                      
     conv2d_55 (Conv2D)             (None, 24, 32, 128)  295040      ['concatenate_7[0][0]']          
                                                                                                      
     conv2d_56 (Conv2D)             (None, 24, 32, 128)  147584      ['conv2d_55[0][0]']              
                                                                                                      
     conv2d_transpose_9 (Conv2DTran  (None, 48, 64, 64)  73792       ['conv2d_56[0][0]']              
     spose)                                                                                           
                                                                                                      
     concatenate_8 (Concatenate)    (None, 48, 64, 128)  0           ['conv2d_transpose_9[0][0]',     
                                                                      'conv2d_46[0][0]']              
                                                                                                      
     conv2d_57 (Conv2D)             (None, 48, 64, 64)   73792       ['concatenate_8[0][0]']          
                                                                                                      
     conv2d_58 (Conv2D)             (None, 48, 64, 64)   36928       ['conv2d_57[0][0]']              
                                                                                                      
     conv2d_transpose_10 (Conv2DTra  (None, 96, 128, 32)  18464      ['conv2d_58[0][0]']              
     nspose)                                                                                          
                                                                                                      
     concatenate_9 (Concatenate)    (None, 96, 128, 64)  0           ['conv2d_transpose_10[0][0]',    
                                                                      'conv2d_44[0][0]']              
                                                                                                      
     conv2d_59 (Conv2D)             (None, 96, 128, 32)  18464       ['concatenate_9[0][0]']          
                                                                                                      
     conv2d_60 (Conv2D)             (None, 96, 128, 32)  9248        ['conv2d_59[0][0]']              
                                                                                                      
     conv2d_61 (Conv2D)             (None, 96, 128, 32)  9248        ['conv2d_60[0][0]']              
                                                                                                      
     conv2d_62 (Conv2D)             (None, 96, 128, 23)  759         ['conv2d_61[0][0]']              
...
```
    ...
    Epoch 1/5
    34/34 [==============================] - 20s 207ms/step - loss: 1.7923 - accuracy: 0.4683
    Epoch 2/5
    34/34 [==============================] - 2s 62ms/step - loss: 0.7647 - accuracy: 0.7896
    Epoch 3/5
    34/34 [==============================] - 2s 63ms/step - loss: 0.5718 - accuracy: 0.8205
    Epoch 4/5
    34/34 [==============================] - 2s 63ms/step - loss: 0.4851 - accuracy: 0.8546
    Epoch 5/5
    34/34 [==============================] - 2s 63ms/step - loss: 0.3841 - accuracy: 0.8842
...
```
    ...
    [<matplotlib.lines.Line2D at 0x7e5fcc16afd0>]
